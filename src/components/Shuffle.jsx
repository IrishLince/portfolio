...
const Shuffle = ({
  ...
  const baseTw = 'inline-block whitespace-normal break-words will-change-transform uppercase text-base sm:text-xl md:text-2xl lg:text-3xl xl:text-[4rem] leading-none';
