...
// Memoize skill arrays outside component
const HARD_SKILLS = [
...
// Memoized SkillCard component
const SkillCard = memo(({ skill, index }: { skill: typeof HARD_SKILLS[0]; index: number }) => (
  <motion.div
  ...
  >
    <div className={`absolute inset-0 bg-gradient-to-r ${skill.color} rounded-lg blur opacity-0 group-hover:opacity-75 transition-opacity duration-300`}></div>
